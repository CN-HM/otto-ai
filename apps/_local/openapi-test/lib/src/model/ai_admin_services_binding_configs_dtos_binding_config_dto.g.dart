...
part of 'ai_admin_services_binding_configs_dtos_binding_config_dto.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AiAdminServicesBindingConfigsDtosBindingConfigDto
    extends AiAdminServicesBindingConfigsDtosBindingConfigDto {
  @override
  final String? id;
  @override
  final String? code;
  ...
  factory _$AiAdminServicesBindingConfigsDtosBindingConfigDto(
          [void Function(
  ...
  _$AiAdminServicesBindingConfigsDtosBindingConfigDto._(
      {this.id,
      this.code,
      this.name,
      this.description,
      ...
      : super._();
  @override
  AiAdminServicesBindingConfigsDtosBindingConfigDto rebuild(
          void Function(
                  AiAdminServicesBindingConfigsDtosBindingConfigDtoBuilder)
              updates) =>
  ...
  @override
  AiAdminServicesBindingConfigsDtosBindingConfigDtoBuilder toBuilder() =>
      AiAdminServicesBindingConfigsDtosBindingConfigDtoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AiAdminServicesBindingConfigsDtosBindingConfigDto &&
        id == other.id &&
        code == other.code &&
        name == other.name &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'AiAdminServicesBindingConfigsDtosBindingConfigDto')
          ..add('id', id)
          ..add('code', code)
          ..add('name', name)
...
class AiAdminServicesBindingConfigsDtosBindingConfigDtoBuilder
    implements
        Builder<AiAdminServicesBindingConfigsDtosBindingConfigDto,
            AiAdminServicesBindingConfigsDtosBindingConfigDtoBuilder> {
  _$AiAdminServicesBindingConfigsDtosBindingConfigDto? _$v;
  ...
  AiAdminServicesBindingConfigsDtosBindingConfigDtoBuilder() {
    AiAdminServicesBindingConfigsDtosBindingConfigDto._defaults(this);
  }

  AiAdminServicesBindingConfigsDtosBindingConfigDtoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _code = $v.code;
  ...
  @override
  void replace(AiAdminServicesBindingConfigsDtosBindingConfigDto other) {
    _$v = other as _$AiAdminServicesBindingConfigsDtosBindingConfigDto;
  }

  @override
  void update(
      void Function(AiAdminServicesBindingConfigsDtosBindingConfigDtoBuilder)?
          updates) {
    if (updates != null) updates(this);
  }

  @override
  AiAdminServicesBindingConfigsDtosBindingConfigDto build() => _build();

  _$AiAdminServicesBindingConfigsDtosBindingConfigDto _build() {
    final _$result = _$v ??
        _$AiAdminServicesBindingConfigsDtosBindingConfigDto._(
          id: id,
          code: code,
