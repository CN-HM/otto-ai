...
part 'ai_admin_services_agent_roles_dtos_agent_role_dto.g.dart';
...
/// * [knowledgeBindings] 
@BuiltValue()
abstract class AiAdminServicesAgentRolesDtosAgentRoleDto implements Built<AiAdminServicesAgentRolesDtosAgentRoleDto, AiAdminServicesAgentRolesDtosAgentRoleDtoBuilder> {
  ...
  @BuiltValueField(wireName: r'memoryLibraryId')
  String? get memoryLibraryId;
  ...
  @BuiltValueField(wireName: r'currentReleaseId')
  String? get currentReleaseId;
  ...
  AiAdminServicesAgentRolesDtosAgentRoleDto._();

  factory AiAdminServicesAgentRolesDtosAgentRoleDto([void updates(AiAdminServicesAgentRolesDtosAgentRoleDtoBuilder b)]) = _$AiAdminServicesAgentRolesDtosAgentRoleDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AiAdminServicesAgentRolesDtosAgentRoleDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AiAdminServicesAgentRolesDtosAgentRoleDto> get serializer => _$AiAdminServicesAgentRolesDtosAgentRoleDtoSerializer();
}

class _$AiAdminServicesAgentRolesDtosAgentRoleDtoSerializer implements PrimitiveSerializer<AiAdminServicesAgentRolesDtosAgentRoleDto> {
  @override
  final Iterable<Type> types = const [AiAdminServicesAgentRolesDtosAgentRoleDto, _$AiAdminServicesAgentRolesDtosAgentRoleDto];

  @override
  final String wireName = r'AiAdminServicesAgentRolesDtosAgentRoleDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AiAdminServicesAgentRolesDtosAgentRoleDto object, {
    ...
    if (object.memoryLibraryId != null) {
      yield r'memoryLibraryId';
      yield serializers.serialize(
        object.memoryLibraryId,
        specifiedType: const FullType.nullable(String),
      );
    }
    ...
    if (object.currentReleaseId != null) {
      yield r'currentReleaseId';
      yield serializers.serialize(
  ...
  void _deserializeProperties(
    ...
    required AiAdminServicesAgentRolesDtosAgentRoleDtoBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'memoryEnabled':
          ...
          break;
        case r'memoryLibraryId':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(String),
          ) as String?;
          if (valueDes == null) continue;
          result.memoryLibraryId = valueDes;
          break;
        ...
        case r'language':
          ...
          break;
        case r'currentReleaseId':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(String),
          ) as String?;
          if (valueDes == null) continue;
          result.currentReleaseId = valueDes;
          break;
  ...
  @override
  AiAdminServicesAgentRolesDtosAgentRoleDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AiAdminServicesAgentRolesDtosAgentRoleDtoBuilder();
